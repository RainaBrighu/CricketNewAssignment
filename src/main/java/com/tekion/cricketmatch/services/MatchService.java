...
public class MatchService {
    ...
    public String playMatch(Matches match) {
        ...
        List<ScoreCard> battingTeamPlayers = iScoreCardRepo.getAllPlayerByTeamId(match.getMatchId(),match.getFirstTeamId());
        List<ScoreCard> bowlingTeamPlayers = iScoreCardRepo.getAllPlayerByTeamId(match.getMatchId(),match.getSecondTeamId());
        ...
        secondInnings.startInnings(firstInnings.getTotalScore(),bowlingTeamPlayers,battingTeamPlayers,overs);
        ...
        if(match.getFirstInningScore() > match.getSecondInningScore())
            ...
            match.setWinningTeam(match.getSecondTeamId());
